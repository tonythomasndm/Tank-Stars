...
public class GameScreen implements Screen, Serializable {
    ...
    public GameScreen(final TankGame game) {
        this.game = game;
...
//                }
        ...
        Iterator<Rectangle> shooot=shooting.iterator();
        while(shooot.hasNext()){
            Rectangle obj=shooot.next();
            obj.x+=150*Gdx.graphics.getDeltaTime();
        }

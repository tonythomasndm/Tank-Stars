...
public class GameScreen2 extends GameScreen implements Screen, Serializable {
    final TankGame game;
    Texture gamescr;
    ...
    public GameScreen2(final TankGame game) {
        super(game);
        this.game = game;
        gamescr = new Texture(Gdx.files.internal("FUEL.png"));
        tank1 = new Texture(Gdx.files.internal("Tank2.png"));
        tank2 = new Texture(Gdx.files.internal("revtank1.png"));
        ...
        Tank1 = new Rectangle(100, 261, 160, 55);
        Tank2 = new Rectangle(1080, 261, 120, 60);
...
//                tank1 = new Texture(Gdx.files.internal("revTank2.png"));
//                dir1 = 1;
//            }
...
//                    tank2 = new Texture(Gdx.files.internal("Tank1.png"));
//                    dir2 = 1;
//                }
//                if (Gdx.input.isKeyPressed(Input.Keys.T)) {
//                    tank2 = new Texture(Gdx.files.internal("revTank1.png"));
